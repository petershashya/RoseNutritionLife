...
def post_about(request, about_id=None):
    user_rank = getattr(request.user.user_detail, 'company_rank', '').lower()
    if user_rank not in ["manager", "doctor", "director","vice_director","manager","business_teacher","video grapher","doctor","secretary","stationay","pharmacist","displine","advisor","it_officer"]:
